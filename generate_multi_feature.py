...
def get_NABert_embdedding(sequences):

    tokenizer = BertTokenizer.from_pretrained("/home/zhangbin/SOFB-master/save_model/NABert", do_lower_case=False)
    model = BertModel.from_pretrained("/home/zhangbin/SOFB-master/save_model/NABert")
...
def get_ProtT5_embedding(seq_list):
...
if __name__ == '__main__':
    ...
    print('generate NABert_embdedding')
    train_dyna = get_NABert_embdedding(train_seq)
    test_dyna = get_NABert_embdedding(test_seq)
    np.save(save_dir + '/' + 'NABert_train.npy', np.array(train_dyna))
    np.save(save_dir + '/' + 'NABert_test.npy', np.array(test_dyna))

    print('generate ProtT5_embedding')
    train_vec = get_ProtT5_embedding(train_seq)
    test_vec = get_ProtT5_embedding(test_seq)
    np.save(save_dir + '/' + 'ProtT5_train.npy', train_vec)
    np.save(save_dir + '/' + 'ProtT5_test.npy', test_vec)
